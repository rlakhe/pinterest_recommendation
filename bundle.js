...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_Conversation2.default, null), document.getElementById('app'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ChatMainDiv = function (_React$Component) {
		_inherits(ChatMainDiv, _React$Component);

		function ChatMainDiv() {
			_classCallCheck(this, ChatMainDiv);

			return _possibleConstructorReturn(this, (ChatMainDiv.__proto__ || Object.getPrototypeOf(ChatMainDiv)).apply(this, arguments));
		}

		_createClass(ChatMainDiv, [{
			key: 'render',
			value: function render() {
				var style = { position: 'fixed', top: '20px' };
				return _react2.default.createElement(
					'div',
					{ className: 'col-md-4 col-sm-offset-4 frame' },
					_react2.default.createElement(ChatContainer, null),
					_react2.default.createElement(ChatTextArea, null)
				);
			}
		}]);
	...
	var ChatContainer = function (_React$Component2) {
		_inherits(ChatContainer, _React$Component2);
	...
	var ChatTextArea = function (_React$Component3) {
		_inherits(ChatTextArea, _React$Component3);

		function ChatTextArea() {
			_classCallCheck(this, ChatTextArea);

			return _possibleConstructorReturn(this, (ChatTextArea.__proto__ || Object.getPrototypeOf(ChatTextArea)).apply(this, arguments));
		}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'msj-rta macro', style: style_parent },
						_react2.default.createElement(
							'div',
							{ className: 'text text-r', style: style_child },
							_react2.default.createElement('textarea', { className: 'mytext', cols: '30', rows: '2', placeholder: 'Type a message' })
						)
					)
				);
			}
	...
	var StaticPinterest = function (_React$Component4) {
		_inherits(StaticPinterest, _React$Component4);

		function StaticPinterest() {
			_classCallCheck(this, StaticPinterest);

			return _possibleConstructorReturn(this, (StaticPinterest.__proto__ || Object.getPrototypeOf(StaticPinterest)).apply(this, arguments));
		}

		_createClass(StaticPinterest, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('a', { 'data-pin-do': 'embedBoard', 'data-pin-board-width': '400', 'data-pin-scale-height': '240', 'data-pin-scale-width': '80', href: 'https://uk.pinterest.com/s_maskey/ring/' })
				);
			}
		}]);

		return StaticPinterest;
	}(_react2.default.Component);

	exports.default = ChatMainDiv;
